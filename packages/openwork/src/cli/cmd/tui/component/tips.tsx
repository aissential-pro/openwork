...
const TIPS = [
  ...
  "Create a plugin to prevent OpenWork from reading sensitive files",
  "Use {highlight}openwork run{/highlight} for non-interactive scripting",
  "Use {highlight}openwork --continue{/highlight} to resume the last session",
  "Use {highlight}openwork run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}openwork serve{/highlight} for headless API access to OpenWork",
  "Use {highlight}openwork run --attach{/highlight} to connect to a running server",
  "Run {highlight}openwork upgrade{/highlight} to update to the latest version",
  "Run {highlight}openwork auth list{/highlight} to see all configured providers",
  "Run {highlight}openwork agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}openwork github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}openwork debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with OpenWork Zen for curated, tested models",
