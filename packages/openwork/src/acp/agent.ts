...
import type { Event, OpencodeClient, SessionMessageResponse } from "@openwork/sdk/v2"
  ...
  export class Agent implements ACPAgent {
    ...
    async initialize(params: InitializeRequest): Promise<InitializeResponse> {
      ...
      const authMethod: AuthMethod = {
        description: "Run `openwork auth login` in the terminal",
        name: "Login with openwork",
        id: "opencode-login",
      }
